...
export const BOOKS: Book[] = [
  {
    ...
    description: `A recipe-based book to help you efficiently create
    amazing PHP-based applications with Laravel 5.x,
  ...
  },
  {
    ...
    authors: 'Bass Jobsen',
    published: 'April 2016',
    description: `Over 120 practical and easy-to-understand recipes that explain how to use Sass and Compass to write
    efficient, maintainable, and reusable CSS code for your web development projects,
